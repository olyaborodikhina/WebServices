 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://hello.ws/", wsdlLocation = "http://localhost:8080/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://hello.ws/", "HelloImplService");
    ...
    public HelloService getHelloImplPort() {
        return super.getPort(new QName("http://hello.ws/", "HelloImplPort"), HelloService.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloImplPort")
    public HelloService getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hello.ws/", "HelloImplPort"), HelloService.class, features);
    }
